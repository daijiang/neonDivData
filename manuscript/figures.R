...
p2 = ggplot(mutate(sp_rich_plant_transf, 
                   island = ifelse(siteID %in% c("LAJA", "GUAN", "PUUM"), "Y", "N")),
...
# Fig. 3 Species accumulation figure for Beetles ----
...
ggsave("manuscript/figures/beetle_rarefaction.pdf", 
       plot = beetle_rarefac, width = 10.5, height = 5)
ggsave("manuscript/figures/beetle_rarefaction.png", 
       plot = beetle_rarefac, width = 10.5, height = 5)
